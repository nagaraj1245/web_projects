...
<html lang="en">
 ...
 <body>
  <h1 class="aafg" > Registration Page </h1>
  <?php
  if(isset($_POST["sub"]))
  {
	  $a=trim($_POST["pass"]); $b=trim($_POST["confirm_pass"]); $c=trim($_POST["mail-id"]);$d=array(trim($_POST['first']);
  ...
  <div  style="background-color:#e0e0e0;margin-top:2em;padding:5%;margin-left:35%;position:absolute;font-family:'Times New Roman'">
